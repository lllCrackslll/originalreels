    ...
    <div className="px-4 sm:px-8 py-8 max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm mt-1.5">
          Déposez votre Reel ou Short et choisissez les transformations à appliquer.
        </p>
      </div>

      {/* Quota */}
      <div className="flex items-center justify-between px-4 py-3 bg-orange-50 border border-orange-100 rounded-2xl mb-8">
        <div>
